...
it('should convert from Script', () => {
  ...
  {
    const address = fromScriptP2WSH(script, 'mainnet')
    expect(address).toStrictEqual('df1qncd7qa2cafwv3cpw68vqczg3qj904k2f4lard4wrj50rzkwmagvsfkkf88')
  ...
  {
    const address = fromScriptP2WSH(script, 'testnet')
    expect(address).toStrictEqual('tf1qncd7qa2cafwv3cpw68vqczg3qj904k2f4lard4wrj50rzkwmagvsemeex5')
  ...
  {
    const address = fromScriptP2WSH(script, 'regtest')
    expect(address).toStrictEqual('bcrt1qncd7qa2cafwv3cpw68vqczg3qj904k2f4lard4wrj50rzkwmagvssfsq3t')
