...
export class Loan {
   ...
   */
  async listCollateralTokens (collateralToken: GetCollateralToken = {}): Promise<CollateralTokensData> {
   ...
   */
  async getCollateralToken (token: string | number): Promise<CollateralTokenDetails> {
