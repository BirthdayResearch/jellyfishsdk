  ...
  describe('listAddressGroupings', () => {
    it('should listAddressGroupings', async () => {
      return await waitForExpect(async () => {
        ...
        expect((data[0][0][1] as BigNumber).isGreaterThanOrEqualTo(new BigNumber('0'))).toStrictEqual(true)
        ...
        expect((data[1][0][1] as BigNumber).isGreaterThanOrEqualTo(new BigNumber('0'))).toStrictEqual(true)
