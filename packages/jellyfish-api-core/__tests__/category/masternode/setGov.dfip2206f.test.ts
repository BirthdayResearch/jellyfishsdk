...
describe('setGov dfip2206f', () => {
  ...
  it('should futureSwap and withdrawFutureSwap on DFI to DUSD', async () => {
  ...
  it('should not futureSwap as dfip2206f is inactive', async () => {
    await testing.rpc.masternode.setGov({
      ATTRIBUTES: {
    ...
    await expect(promise).rejects.toThrow('DFIP2206F not currently active')
