...
describe('Spv', () => {
  ...
  async function setup (): Promise<void> {
    ...
    await tGroup.waitForAnchorAuths(async () => await tGroup.anchor.generateAnchorAuths(2, initOffsetHour), 2)
  ...
  it('should listAnchorRewards', async () => {
    ...
    const unrewardeds = await tGroup.get(0).container.call('spv_listanchorsunrewarded')
