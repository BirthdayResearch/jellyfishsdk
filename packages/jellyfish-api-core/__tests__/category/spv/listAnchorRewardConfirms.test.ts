...
describe('Spv', () => {
  ...
  async function setup (): Promise<void> {
    ...
    await tGroup.waitForAnchorAuths(async () => await tGroup.anchor.generateAnchorAuths(2, initOffsetHour, 'listAnchorRewardConfirms'), 60)
  ...
  it.skip('should listAnchorRewardConfirms', async () => {
