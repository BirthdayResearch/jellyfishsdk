...
describe('Loan', () => {
  ...
  it('should not setColleteralToken if token does not exist', async () => {
    ...
    const promise = client.loan.setColleteralToken('TSLA', new BigNumber(1), { priceFeedId: oracleId })
  ...
  it('should not setColleteralToken if factor is greater than 1', async () => {
    ...
    const promise = client.loan.setColleteralToken('AAPL', new BigNumber(2), { priceFeedId: oracleId })
  ...
  it('should not setColleteralToken if factor is lesser than 0', async () => {
    ...
    const promise = client.loan.setColleteralToken('AAPL', new BigNumber(-1), { priceFeedId: oracleId })
  ...
  it('should not setColleteralToken if oracleId is not exists', async () => {
    const promise = client.loan.setColleteralToken('AAPL', new BigNumber(1), { priceFeedId: '944d7ce67a0bd6d18e7ba7cbd3ec12ac81a13aa92876cb697ec0b33bf50652f5' })
  ...
  it('should setColleteralToken after block 200 only', async () => {
    ...
    const txId = await client.loan.setColleteralToken('AAPL', new BigNumber(1), { priceFeedId: oracleId, activateAfterBlock: 200 })
  ...
  it('should setColleteralToken with utxos', async () => {
    ...
    const txId = await client.loan.setColleteralToken('AAPL', new BigNumber(1), { priceFeedId: oracleId, utxos: inputs })
  ...
  it('should not setColleteralToken with utxos', async () => {
    ...
    const promise = client.loan.setColleteralToken('AAPL', new BigNumber(1), { priceFeedId: oracleId, utxos: [{ txid, vout }] })
