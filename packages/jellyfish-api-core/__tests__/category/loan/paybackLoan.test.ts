...
describe('paybackLoan before FortCanningHeight', () => {
  ...
  it('should fail with cannot payback loan amount when interest per block becomes negative pre Fort Canning Hill hardfork', async () => {
    await setupPreFCHContainer()
    await setupVault()
