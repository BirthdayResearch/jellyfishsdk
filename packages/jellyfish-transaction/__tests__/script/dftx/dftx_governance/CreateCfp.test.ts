...
it('should bi-directional buffer-object-buffer', () => {
  const fixtures = [
    '6a4b44665478500117a9148b5401d88a3d4e54fc701663dd99a5ab792af0a48700e40b5402000000022354657374696e67206e657720636f6d6d756e6974792066756e642070726f706f73616c'
  ]
...
describe('createCfp', () => {
  const header = '6a4b4466547850' // OP_RETURN(0x6a) OP_PUSHDATA1(0x4b) (length 68 = 0x44) CDfTx.SIGNATURE(0x44665478) CreateProposal.OP_CODE(0x50)
