...
import { CCompositeSwap, OP_CODES, PoolSwap } from '../../../../src'
import { toBuffer, toOPCodes } from '../../../../src/script/_buffer'

it('should bi-directional buffer-object-buffer', () => {
  const fixtures = [
    '6a4c4f44665478ff17a9140806eb42b6d5bb69726909fb6da34a9152afdf048701c7b3240d0000000017a9140806eb42b6d5bb69726909fb6da34a9152afdf048700ffffffffffffff7fffffffffffffff7f',
    '6a4c4f44665478ff17a914c34ca9c54dc87e7e875b212ec6ba0704be3de587870000d6117e0300000017a914c34ca9c54dc87e7e875b212ec6ba0704be3de58787022fe28e7915000080ffcf430300000000',
    '6a4c4f44665478ff17a914635794bb3db157b6dac4dcb7467710a10f03c6ac8700809698000000000017a914582328ee9beebc3fb5844964302cc0fdbb27e04c87022fe28e7915000080ffcf430300000000',
    '6a4c4f44665478ff17a9148646fc3d44c92e190c18db1cf08f430e421dba9887005671518a0000000017a9148646fc3d44c92e190c18db1cf08f430e421dba988707a0860100000000000000000000000000',
    '6a4c4f44665478ff17a9140c1ff6de17f73dad607a2b03b5bd77b4e57327e58707d3e2a0470000000017a9140c1ff6de17f73dad607a2b03b5bd77b4e57327e587002fe28e7915000080ffcf430300000000',
    '6a4c4f44665478ff17a914094b5e971325dee0161beccc7a78592f95c27100870080397a120000000017a914094b5e971325dee0161beccc7a78592f95c2710087022fe28e7915000080ffcf430300000000',
    '6a4c4f44665478ff17a914f64714403dd1b872494851ca4ed8d5071af79ea6870087b4104d0200000017a914f64714403dd1b872494851ca4ed8d5071af79ea68707a0860100000000000000000000000000',
    '6a4c5144665478ff1976a9140b7127e943eaa3f28536c3f046ddbdeb790f691e88ac0080889e2a0100000017a914b3a65aa3fd9c60860bebd231d71b5bc5749ff5be87022fe28e7915000080ffcf430300000000',
    '6a4c4f44665478ff17a9140164e31629342622b35bc134c8e4fe7c45c42e43870205fd0b030000000017a9140164e31629342622b35bc134c8e4fe7c45c42e4387002fe28e7915000080ffcf430300000000',
    '6a4c4f44665478ff17a914963a12667d64728009567ad5eb26777e1673c479870000db7d2e0000000017a914963a12667d64728009567ad5eb26777e1673c47987022fe28e7915000080ffcf430300000000'
  ]
  ...
  fixtures.forEach(hex => {
    ...
    expect((stack[1] as OP_DEFI_TX).tx.type).toStrictEqual(0xff)
  })
})

const header = '6a4c4f44665478ff' // OP_RETURN, PUSH_DATA(44665478, ff)
...
it('should craft dftx with OP_CODES._()', () => {
  const stack = [
    OP_CODES.OP_RETURN,
    OP_CODES.OP_DEFI_TX_COMPOSITE_SWAP(poolSwap)
  ]
...
describe('Composable', () => {
  ...
  it('should compose from composable to buffer', () => {
    const composable = new CCompositeSwap(poolSwap)
...
describe('maxPrice inconsistency should parse from buffer into consistent variant regardless', () => {
  ...
  const inconsistent = '6a4c4f44665478ff17a9141084ef98bacfecbc9f140496b26516ae55d79bfa870000e1f5050000000017a914bb7642fd3a9945fd75aff551d9a740768ac7ca7b87010000000000000000fcb9a6f002000000'
  const consistent = '6a4c4f44665478ff17a9141084ef98bacfecbc9f140496b26516ae55d79bfa870000e1f5050000000017a914bb7642fd3a9945fd75aff551d9a740768ac7ca7b87017e00000000000000fcfba10100000000'
  ...
  it('inconsistent should parse as', () => {
    ...
    expect(tx.type).toStrictEqual(0xff)
