...
import { CSetColleteralToken, SetColleteralToken } from './dftx_loans'
...
export class CDfTx extends ComposableBuffer<DfTx<any>> {
  ...
  static data (dftx: DfTx<any>): BufferComposer {
    ...
    switch (dftx.type) {
      ...
      case CSetColleteralToken.OP_CODE:
        return compose<SetColleteralToken>(CSetColleteralToken.OP_NAME, d => new CSetColleteralToken(d))
      default:
