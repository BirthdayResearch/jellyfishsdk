...
import { OracleIntervalSeconds, OraclePriceAggregatedIntervalMapper } from '../../../model/OraclePriceAggregatedInterval'
import BigNumber from 'bignumber.js'
import { mapPriceFeeds } from './SetOracleData'
...
export class SetOracleDataIntervalIndexer extends DfTxIndexer<SetOracleData> {
  ...
  intervals: OracleIntervalSeconds[] = [
    OracleIntervalSeconds.FIFTEEN_MINUTES,
