...
import { ApiPagedResponse, WhaleApiClient, WhaleApiException, PoolPairData, PoolSwap, PoolSwapAggregated, PoolSwapAggregatedInterval } from '@defichain/whale-api-client'
