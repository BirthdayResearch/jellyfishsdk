...
import { SetupToken } from '../setup/setup.token'
import { SetupDex } from '../setup/setup.dex'
...
import { SetupMasternode } from '../setup/setup.masternode'
import { SetupUtxo } from '../setup/setup.utxo'
import { OracleBot } from '../bot/oracle.bot'
import { SetupLoanScheme } from '../setup/setup.loan.scheme'
import { SetupLoanToken } from '../setup/setup.loan.token'
import { SetupLoanCollateral } from '../setup/setup.loan.collateral'
import { SetupGov } from '../setup/setup.gov'
import { VaultBot } from '../bot/vault.bot'
